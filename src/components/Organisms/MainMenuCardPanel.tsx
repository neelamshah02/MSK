...
import { PageTitle, TileTitle } from '../Atoms';
...
const MainMenuCardPanel: React.FC = () => {
  ...
  return (
    <>
      <PageTitle title={intl.formatMessage({ id: 'menucard.page.title' })} />
      <Section>
        <MenuPanel>
          ...
          {(user.role === Role.VesselOwner ||
            ...
            <Link to="/registerseagoing/person">
              <IconTile
                tileTitle={
                  <TileTitle
                    title={intl.formatMessage({ id: 'menucard.icontile.seagoing.title' })}
                  />
                }
                tileBody={
                  <IconContainer>
          ...
          {(user.role === Role.VesselOwner ||
            ...
            <Link to="/registerassessor/person">
              <IconTile
                tileTitle={
                  <TileTitle
                    title={intl.formatMessage({ id: 'menucard.icontile.assessor.title' })}
                  />
                }
                tileBody={
                  <IconContainer>
